...
public class Book : MonoBehaviour
{
    ...
    public PageCallback covercallback;
    public PageCallback pagecallback;

    public void DoorOpen()
    {
        covercallback.gameObject.GetComponent<Animator>().Play("DoorOpen");
        pagecallback.gameObject.GetComponent<Animator>().Play("DoorOpenPage");
    }
    ...
    void Start()
    {
        ...
        if (bookData.PageList.Length % 2 != 0)
        {
    ...
    private void SetBookArt()
    {
        ...
        if (MainCover != null)
        {
            MainCover.mainTexture = bookData.GetCoverTexture();
        }
        if (bookInSideFrontPage != null)
        {
            bookInSideFrontPage.mainTexture = bookData.GetPage(pageIndex);
        }
        pageIndex++;

        if (bookInSideBackPage != null)
        {
            bookInSideBackPage.mainTexture = bookData.GetPage(pageIndex);
        }
    }
    ...
    public bool CanTurnPage()
    {
        ...
        if (pageIndex == bookData.PageTotal())
    ...
    private void Set_TurnPage()
    {
        ...
        bookInSideBackPage.mainTexture = bookData.GetPage(pageIndex + 2);
    ...
    private void Set_TurnBackPage()
    {
        ...
        bookInSideFrontPage.mainTexture = bookData.GetPage(pageIndex - 3); // back two
    ...
    private void SetPageFront(int _index)
    {
        if (pageFrontMaterial != null)
        {
            pageFrontMaterial.mainTexture = bookData.GetPage(_index);
        }
    }
    private void SetPageBack(int _index)
    {
        if (pageBackMaterial != null)
        {
            pageBackMaterial.mainTexture = bookData.GetPage(_index);
        }
    }
